...
label ch1_main:
    ...
    m "Well, yes and no. Sure, you aren't trying to date the girls, but you are still getting close to them. You are also the MC still. You can't go against the player's wishes."
    m "And like I said, a lot of that could be attributed to something going wrong."
    m "After all, you were running fine until I started messing around with your head a bit."
    ...
    mc "That, that's not true. I have a lot of good qualities."
    ...
    m "Yuri and Natsuki still had their fight, even with you trying to prevent it."
