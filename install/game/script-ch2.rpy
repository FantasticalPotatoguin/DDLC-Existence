...
label ch2_end_yuri:
    ...
    #I've lost track of how to get here, but this is the end of the day. This should happen after the stuff above.
    #It transitions to MC in his room. If we can show that it's nighttime, that would be great.
